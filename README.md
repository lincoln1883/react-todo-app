...
The react todo app was an introduction to concepts like but not limited to props, state,lifecycle, hooks, routing, nested routing and events. 
...
```sh
  cd my-folder run `git clone https://github.com/lincoln1883/react-todo-app/`
```
